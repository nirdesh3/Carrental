...
<?php }} ?>
      ...
      <aside class="col-md-3">
            <h5><i class="aria-hidden="true></i>Book Now</h5>
          <form method="post">  
            <div class="form-group">
              <input type="date" class="form-control" id="datepicker" name="fromdate" placeholder="From Date(dd/mm/yyyy)" required>
            </div>
            <div class="form-group">
              <input type="date" class="form-control" id="datepicker1" name="todate" placeholder="To Date(dd/mm/yyyy)" required>
            </div>
            <div class="form-group">
          ...
          <?php if($_SESSION['login'])
              ...
              <?php } else { ?>
<a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Login First</a>
...
<script>
  const datePickerFrom = document.getElementById('datepicker');
  const datePickerTo = document.getElementById('datepicker1');
  datePickerFrom.min = new Date().toISOString().split("T")[0];
  datePickerTo.min = new Date().toISOString().split("T")[0];
</script>
