      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            ...
            <p>We have the right and the best car you want to rent. </p>
        </div>
      </div>
    </div>
  </div>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>There are many cars that you have a dream to drive on.<span>YOUR DREAM CAR IS HERE.</span> You can select and rent the car you want at your reasonable price and drive for a day or two.</p>
    </div>
    <div class="row"> 
      <!-- Nav tabs -->
      <div class="recent-tab">
          <h3>Here are some of the cars that are available</h3>
      </div>
